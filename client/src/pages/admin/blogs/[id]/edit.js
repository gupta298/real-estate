...
import { getAdminBlog, updateBlog, uploadFile, uploadFiles } from '@/utils/api';
...
export default function EditBlogPage() {
  ...
  const loadBlog = async () => {
    try {
      ...
      if (data.blog) {
        // Migrate featuredImageUrl to thumbnailUrl if thumbnailUrl doesn't exist
        const thumbnailUrl = data.blog.thumbnailUrl || data.blog.featuredImageUrl || '';
        const thumbnailType = data.blog.thumbnailType || (data.blog.featuredImageUrl ? 'image' : '');
